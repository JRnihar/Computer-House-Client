...
const ReviewItem = () => {
    ...
    useEffect(()=>{
        fetch('https://hidden-waters-77384.herokuapp.com/review')
        .then(res=>res.json())
            ...
            <section class="flex items-center justify-center py-20 bg-white ">
                <div class="px-16 bg-white">
                    <div class="flex flex-col  items-start mx-auto lg:items-center">
                        <p class="relative px-3 flex items-start justify-start w-full text-lg font-bold tracking-wider text-purple-500 uppercase lg:justify-center lg:items-center">Don't just take our word for it</p>


                        <h2 class="relative px-3 flex items-start justify-start w-full max-w-3xl text-5xl font-bold lg:justify-center">
