...
const Home = () => {
    return (
     ...
     <ReviewItem></ReviewItem>
            <h1 className='text-2xl text-primary text-center font-bold mb-12'>Get In Touch</h1>
            <body class="font-sans antialiased text-gray-900 bg-gray-200 leading-normal tracking-wider bg-cover">
